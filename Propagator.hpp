...
public:
  ...
  template <typename propagator_options_t> struct State {
    ...
    __host__ __device__ State(const parameters_t &start,
  ...
  __host__ __device__ explicit Propagator(stepper_t stepper)
  ...
  template <typename parameters_t, typename propagator_options_t,
            typename result_t>
  __host__ __device__ void propagate(const parameters_t &start,
