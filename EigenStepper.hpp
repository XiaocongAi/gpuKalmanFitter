...
template <typename bfield_t> struct EigenStepper {
  ...
  struct State {
    ...
    __host__ __device__ explicit State(
  ...
  __host__ __device__ EigenStepper(BField bField = BField())
  ...
  __host__ __device__ Vector3D getField(State & /*state*/,
  ...
  __host__ __device__ double step(propagator_state_t &state) const;
