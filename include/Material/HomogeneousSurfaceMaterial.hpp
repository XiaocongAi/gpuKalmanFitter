...
class HomogeneousSurfaceMaterial
    : public ISurfaceMaterial<HomogeneousSurfaceMaterial> {
public:
...
inline const MaterialSlab &
HomogeneousSurfaceMaterial::materialSlab(const Vector3D & /*gp*/) const {
  return (m_fullMaterial);
}

inline const MaterialSlab &
HomogeneousSurfaceMaterial::materialSlab(size_t /*ib0*/, size_t /*ib1*/) const {
  return (m_fullMaterial);
}
