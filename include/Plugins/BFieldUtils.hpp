...
#include "MagneticField/InterpolatedBFieldMap.hpp"
...
/// [](ActsVector<size_t, 2> binsRZ, ActsVector<size_t, 2> nBinsRZ) {
...
/// @code
/// In this case the function would look like:
/// [](ActsVector<size_t, 3> binsXYZ, ActsVector<size_t, 3> nBinsXYZ) {
