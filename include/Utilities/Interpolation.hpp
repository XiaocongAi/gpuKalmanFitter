...
#include "Utilities/detail/interpolation_impl.hpp"
#include <array>
#include <type_traits>
...
template <typename T, int N, class Point1, class Point2 = Point1,
          class Point3 = Point2>
ACTS_DEVICE_FUNC inline T
interpolate(const Point1 &position, const Point2 &lowerCorner,
            const Point3 &upperCorner,
            const ActsMatrix3<typename T::Scalar, N> &values) {
