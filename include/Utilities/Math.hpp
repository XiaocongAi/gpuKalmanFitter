...
// starting point code for matrix inversion: https://gist.github.com/tgjones/06ddde4d9f7794d3883a
...
ACTS_DEVICE_FUNC Eigen::MatrixXd submatrix(Eigen::MatrixXd m, int row, int col) {
